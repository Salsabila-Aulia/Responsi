...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" type="Local Area Network" size="" name="File Geodatabase Feature Class" mimeType="" description=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:4326" miny="0" minx="0" minz="0" dimensions="2" maxy="0" maxz="0" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
